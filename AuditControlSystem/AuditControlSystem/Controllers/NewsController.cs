...
namespace AuditControlSystem.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NewsId,NewsTitle,NewsContent")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NewsId,NewsTitle,NewsContent")] News news)
        {
            if (ModelState.IsValid)
            {
